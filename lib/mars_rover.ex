defmodule MarsRover do
  ...
  defp do_send_command(%MarsRover{x: x, y: y, face: face}, ["L" | next_commands]) do
    face
    |> rotate_left()
    |> build_rover(x, y)
  ...
  defp do_send_command(%MarsRover{x: x, y: y, face: face}, ["R" | next_commands]) do
    face
    |> rotate_right()
    |> build_rover(x, y)
    |> do_send_command(next_commands)
  ...
  defp do_send_command(%MarsRover{x: x, y: y, face: "N"}, ["M" | next_commands]) do
    build_rover("N", x, y + 1)
    |> do_send_command(next_commands)
  end

  defp do_send_command(%MarsRover{x: x, y: y, face: "E"}, ["M" | next_commands]) do
    build_rover("E", x + 1, y)
    |> do_send_command(next_commands)
  end

  defp do_send_command(%MarsRover{x: x, y: y, face: "S"}, ["M" | next_commands]) do
    build_rover("S", x, y - 1)
    |> do_send_command(next_commands)
  end

  defp do_send_command(%MarsRover{x: x, y: y, face: "W"}, ["M" | next_commands]) do
    build_rover("W", x - 1, y)
    |> do_send_command(next_commands)
  end
